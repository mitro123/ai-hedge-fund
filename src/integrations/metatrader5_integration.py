...
class MetaTrader5Integration:
    ...
    def get_historical_data(self, symbol: str, timeframe: str = "M1", count: int = 1000) -> Optional[pd.DataFrame]:
        """
    ...
    def place_order(
        ...
        try:
            ...
            if result is None:
                error = mt5.last_error()
                return TradeResult(
                    success=False, order_id=None, error_code=error[0], error_message=error[1], price=None, volume=None
                )
