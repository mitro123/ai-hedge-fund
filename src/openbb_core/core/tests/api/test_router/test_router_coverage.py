...
def test_get_provider_coverage(mock_command_map):
    ...
    mock_command_map.return_value.provider_coverage = {"provider1": ["coverage1", "coverage2"]}
...
def test_get_command_coverage(mock_command_map):
    ...
    mock_command_map.return_value.command_coverage = {"command1": ["coverage1", "coverage2"]}
