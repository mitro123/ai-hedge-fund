...
class LatestFinancialReportsData(Data):
    ...
    period_ending: Optional[dateType] = Field(default=None, description="Report for the period ending.")
    ...
    sic: Optional[str] = Field(default=None, description="Standard Industrial Classification code.")
