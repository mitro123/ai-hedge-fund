...
class GovernmentTradesQueryParams(QueryParams):
    ...
    chamber: Literal["house", "senate", "all"] = Field(default="all", description="Government Chamber.")
    limit: Optional[NonNegativeInt] = Field(default=100, description=QUERY_DESCRIPTIONS.get("limit", ""))
...
class GovernmentTradesData(Data):
    ...
    transaction_date: Optional[dateType] = Field(default=None, description="Date of Transaction.")
    representative: Optional[str] = Field(default=None, description="Name of Representative.")
