...
class BP6BopUsdData(Data):
    ...
    balance_total: Optional[float] = Field(default=None, description="Current Account Total Balance (USD)")
    ...
    balance_total_goods: Optional[float] = Field(default=None, description="Current Account Total Goods Balance (USD)")
    ...
    credits_total_goods: Optional[float] = Field(default=None, description="Current Account Credits Total Goods (USD)")
    ...
    credits_total: Optional[float] = Field(default=None, description="Current Account Credits Total (USD)")
    ...
    debits_total_goods: Optional[float] = Field(default=None, description="Current Account Debits Total Goods (USD)")
    debits_total_primary_income: Optional[float] = Field(
        default=None, description="Current Account Debits Total Primary Income (USD)"
    )
    debits_total: Optional[float] = Field(default=None, description="Current Account Debits Total (USD)")
...
class ECBMain(Data):
    ...
    current_account: Optional[float] = Field(default=None, description="Current Account Balance (Billions of EUR)")
    goods: Optional[float] = Field(default=None, description="Goods Balance (Billions of EUR)")
    services: Optional[float] = Field(default=None, description="Services Balance (Billions of EUR)")
    primary_income: Optional[float] = Field(default=None, description="Primary Income Balance (Billions of EUR)")
    secondary_income: Optional[float] = Field(default=None, description="Secondary Income Balance (Billions of EUR)")
    capital_account: Optional[float] = Field(default=None, description="Capital Account Balance (Billions of EUR)")
    ...
    financial_account: Optional[float] = Field(default=None, description="Financial Account Balance (Billions of EUR)")
    direct_investment: Optional[float] = Field(default=None, description="Direct Investment Balance (Billions of EUR)")
    ...
    other_investment: Optional[float] = Field(default=None, description="Other Investment Balance (Billions of EUR)")
    reserve_assets: Optional[float] = Field(default=None, description="Reserve Assets Balance (Billions of EUR)")
    errors_and_ommissions: Optional[float] = Field(default=None, description="Errors and Omissions (Billions of EUR)")
...
class ECBSummary(Data):
    ...
    current_account_debit: Optional[float] = Field(default=None, description="Current Account Debit (Billions of EUR)")
    current_account_balance: Optional[float] = Field(
        default=None, description="Current Account Balance (Billions of EUR)"
    )
    goods_credit: Optional[float] = Field(default=None, description="Goods Credit (Billions of EUR)")
    goods_debit: Optional[float] = Field(default=None, description="Goods Debit (Billions of EUR)")
    services_credit: Optional[float] = Field(default=None, description="Services Credit (Billions of EUR)")
    services_debit: Optional[float] = Field(default=None, description="Services Debit (Billions of EUR)")
    primary_income_credit: Optional[float] = Field(default=None, description="Primary Income Credit (Billions of EUR)")
    ...
    primary_income_debit: Optional[float] = Field(default=None, description="Primary Income Debit (Billions of EUR)")
    ...
    capital_account_debit: Optional[float] = Field(default=None, description="Capital Account Debit (Billions of EUR)")
...
class ECBServices(Data):
    ...
    services_total_credit: Optional[float] = Field(default=None, description="Services Total Credit (Billions of EUR)")
    services_total_debit: Optional[float] = Field(default=None, description="Services Total Debit (Billions of EUR)")
    transport_credit: Optional[float] = Field(default=None, description="Transport Credit (Billions of EUR)")
    transport_debit: Optional[float] = Field(default=None, description="Transport Debit (Billions of EUR)")
    travel_credit: Optional[float] = Field(default=None, description="Travel Credit (Billions of EUR)")
    travel_debit: Optional[float] = Field(default=None, description="Travel Debit (Billions of EUR)")
    ...
    communications_credit: Optional[float] = Field(default=None, description="Communications Credit (Billions of EUR)")
    communications_debit: Optional[float] = Field(default=None, description="Communications Debit (Billions of EUR)")
    ...
    other_services_credit: Optional[float] = Field(default=None, description="Other Services Credit (Billions of EUR)")
    other_services_debit: Optional[float] = Field(default=None, description="Other Services Debit (Billions of EUR)")
...
class ECBInvestmentIncome(Data):
    ...
    equity_credit: Optional[float] = Field(default=None, description="Equity Credit (Billions of EUR)")
    ...
    equity_debit: Optional[float] = Field(default=None, description="Equity Debit (Billions of EUR)")
    ...
    reserve_assets_credit: Optional[float] = Field(default=None, description="Reserve Assets Credit (Billions of EUR)")
...
class ECBDirectInvestment(Data):
    ...
    assets_total: Optional[float] = Field(default=None, description="Assets Total (Billions of EUR)")
    assets_equity: Optional[float] = Field(default=None, description="Assets Equity (Billions of EUR)")
    assets_debt_instruments: Optional[float] = Field(
        default=None, description="Assets Debt Instruments (Billions of EUR)"
    )
    assets_mfi: Optional[float] = Field(default=None, description="Assets MFIs (Billions of EUR)")
    assets_non_mfi: Optional[float] = Field(default=None, description="Assets Non MFIs (Billions of EUR)")
    ...
    liabilities_total: Optional[float] = Field(default=None, description="Liabilities Total (Billions of EUR)")
    liabilities_equity: Optional[float] = Field(default=None, description="Liabilities Equity (Billions of EUR)")
    liabilities_debt_instruments: Optional[float] = Field(
        default=None, description="Liabilities Debt Instruments (Billions of EUR)"
    )
    liabilities_mfi: Optional[float] = Field(default=None, description="Liabilities MFIs (Billions of EUR)")
    liabilities_non_mfi: Optional[float] = Field(default=None, description="Liabilities Non MFIs (Billions of EUR)")
...
class ECBPortfolioInvestment(Data):
    ...
    assets_equity_shares: Optional[float] = Field(default=None, description="Assets Equity Shares (Billions of EUR)")
    ...
    assets_debt_long_term: Optional[float] = Field(default=None, description="Assets Debt Long Term (Billions of EUR)")
...
class ECBOtherInvestment(Data):
    ...
    assets_loans: Optional[float] = Field(default=None, description="Assets Loans (Billions of EUR)")
    ...
    assets_eurosystem: Optional[float] = Field(default=None, description="Assets Eurosystem (Billions of EUR)")
    assets_other_mfi_ex_eurosystem: Optional[float] = Field(
        default=None,
        description="Assets Other MFIs outside Eurosystem (Billions of EUR)",
    )
    assets_government: Optional[float] = Field(default=None, description="Assets Government (Billions of EUR)")
    assets_other_sectors: Optional[float] = Field(default=None, description="Assets Other Sectors (Billions of EUR)")
    liabilities_total: Optional[float] = Field(default=None, description="Liabilities Total (Billions of EUR)")
    ...
    liabilities_loans: Optional[float] = Field(default=None, description="Liabilities Loans (Billions of EUR)")
