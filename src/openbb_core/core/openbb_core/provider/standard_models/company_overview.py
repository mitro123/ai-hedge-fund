...
class CompanyOverviewData(Data):
    ...
    vol_avg: Optional[ForceInt] = Field(default=None, description="Volume average of the company.")
    mkt_cap: Optional[ForceInt] = Field(default=None, description="Market capitalization of the company.")
    last_div: Optional[float] = Field(default=None, description="Last dividend of the company.")
    range: Optional[str] = Field(default=None, description="Range of the company.")
    changes: Optional[float] = Field(default=None, description="Changes of the company.")
    company_name: Optional[str] = Field(default=None, description="Company name of the company.")
    currency: Optional[str] = Field(default=None, description="Currency of the company.")
    ...
    exchange: Optional[str] = Field(default=None, description="Exchange of the company.")
    exchange_short_name: Optional[str] = Field(default=None, description="Exchange short name of the company.")
    ...
    description: Optional[str] = Field(default=None, description="Description of the company.")
    ...
    full_time_employees: Optional[str] = Field(default=None, description="Full time employees of the company.")
    ...
    dcf_diff: Optional[float] = Field(default=None, description="Discounted cash flow difference of the company.")
    dcf: Optional[float] = Field(default=None, description="Discounted cash flow of the company.")
    image: Optional[str] = Field(default=None, description="Image of the company.")
    ipo_date: Optional[date] = Field(default=None, description="IPO date of the company.")
