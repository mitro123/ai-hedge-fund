...
class IndexSnapshotsQueryParams(QueryParams):
    ...
    region: str = Field(default="us", description="The region of focus for the data - i.e., us, eu.")
...
class IndexSnapshotsData(Data):
    ...
    price: Optional[float] = Field(default=None, description="Current price of the index.")
    ...
    volume: Optional[int] = Field(default=None, description=DATA_DESCRIPTIONS.get("volume", ""))
    prev_close: Optional[float] = Field(default=None, description=DATA_DESCRIPTIONS.get("prev_close", ""))
    change: Optional[float] = Field(default=None, description="Change in value of the index.")
