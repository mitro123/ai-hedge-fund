...
class AvailableIndicatorsData(Data):
    ...
    symbol_root: Optional[str] = Field(default=None, description="The root symbol representing the indicator.")
    symbol: Optional[str] = Field(
        default=None,
        description=DATA_DESCRIPTIONS.get("symbol", "") + " The root symbol with additional codes.",
    )
    ...
    description: Optional[str] = Field(default=None, description="The description of the indicator.")
    frequency: Optional[str] = Field(default=None, description="The frequency of the indicator data.")
