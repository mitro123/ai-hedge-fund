...
class EconomicIndicatorsQueryParams(QueryParams):
    ...
    country: Optional[str] = Field(
        default=None,
        description=QUERY_DESCRIPTIONS.get("country", "") + " The country represented by the indicator, if available.",
    )
...
class EconomicIndicatorsData(Data):
    ...
    symbol_root: Optional[str] = Field(default=None, description="The root symbol for the indicator (e.g. GDP).")
    symbol: Optional[str] = Field(default=None, description=DATA_DESCRIPTIONS.get("symbol", ""))
    country: Optional[str] = Field(default=None, description="The country represented by the data.")
    value: Optional[Union[int, float]] = Field(default=None, description=DATA_DESCRIPTIONS.get("value", ""))
