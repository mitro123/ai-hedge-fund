...
class PROJECTIONData(Data):
    ...
    central_tendency_high: Optional[float] = Field(description="Central tendency of high projection of rates.")
    ...
    central_tendency_midpoint: Optional[float] = Field(description="Central tendency of midpoint projection of rates.")
    range_low: Optional[float] = Field(description="Low projection of rates.")
    central_tendency_low: Optional[float] = Field(description="Central tendency of low projection of rates.")
