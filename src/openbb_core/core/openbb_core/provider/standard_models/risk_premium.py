...
class RiskPremiumData(Data):
    ...
    continent: Optional[str] = Field(default=None, description="Continent of the country.")
    total_equity_risk_premium: Optional[PositiveFloat] = Field(
        default=None, description="Total equity risk premium for the country."
    )
    country_risk_premium: Optional[NonNegativeFloat] = Field(default=None, description="Country-specific risk premium.")
