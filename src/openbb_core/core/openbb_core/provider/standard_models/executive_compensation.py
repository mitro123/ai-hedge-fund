...
class ExecutiveCompensationData(Data):
    ...
    name_and_position: Optional[str] = Field(default=None, description="Name and position.")
    salary: Optional[NonNegativeFloat] = Field(default=None, description="Salary.")
    bonus: Optional[NonNegativeFloat] = Field(default=None, description="Bonus payments.")
    stock_award: Optional[NonNegativeFloat] = Field(default=None, description="Stock awards.")
    incentive_plan_compensation: Optional[NonNegativeFloat] = Field(
        default=None, description="Incentive plan compensation."
    )
    all_other_compensation: Optional[NonNegativeFloat] = Field(default=None, description="All other compensation.")
    total: Optional[NonNegativeFloat] = Field(default=None, description="Total compensation.")
