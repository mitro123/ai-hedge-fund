...
class AnalystSearchQueryParams(QueryParams):
    ...
    analyst_name: Optional[str] = Field(
        default=None,
        description="Analyst names to return." + " Omitting will return all available analysts.",
    )
    firm_name: Optional[str] = Field(
        default=None,
        description="Firm names to return." + " Omitting will return all available firms.",
    )
