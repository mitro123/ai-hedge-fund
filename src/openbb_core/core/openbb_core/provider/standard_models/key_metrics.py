...
class KeyMetricsQueryParams(QueryParams):
    ...
    limit: Optional[int] = Field(default=100, description=QUERY_DESCRIPTIONS.get("limit", ""))
...
class KeyMetricsData(Data):
    ...
    pe_ratio: Optional[float] = Field(default=None, description="Price-to-earnings ratio (P/E ratio)")
