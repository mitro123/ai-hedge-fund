...
class SurveyOfEconomicConditionsChicagoData(Data):
    ...
    one_year_outlook: Optional[float] = Field(default=None, description="One Year Outlook Index.")
    manufacturing_activity: Optional[float] = Field(default=None, description="Manufacturing Activity Index.")
    non_manufacturing_activity: Optional[float] = Field(default=None, description="Non-Manufacturing Activity Index.")
    capital_expenditures_expectations: Optional[float] = Field(
        default=None, description="Capital Expenditures Expectations Index."
    )
    hiring_expectations: Optional[float] = Field(default=None, description="Hiring Expectations Index.")
    current_hiring: Optional[float] = Field(default=None, description="Current Hiring Index.")
    labor_costs: Optional[float] = Field(default=None, description="Labor Costs Index.")
    non_labor_costs: Optional[float] = Field(default=None, description="Non-Labor Costs Index.")
