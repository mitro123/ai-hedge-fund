...
class CurrencyHistoricalQueryParams(QueryParams):
    ...
    def validate_symbol(cls, v: Union[str, List[str], Set[str]]):  # pylint: disable=E0213
...
class CurrencyHistoricalData(Data):
    ...
    volume: Optional[float] = Field(description=DATA_DESCRIPTIONS.get("volume", ""), default=None)
